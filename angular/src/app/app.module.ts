...
//for %n in ( page-register, page-login, page-feed, page-profile, page-messages, page-searches, page-friend-requests, result-request, post, sidebar, topbar, form-bg) do ng g c %n
